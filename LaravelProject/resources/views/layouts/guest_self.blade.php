...
<body>
    <div id="site">
        <div id="container">
                    ...
                    <div class="wp-inner">
                        ...
                        <div id="search-wp" class="fl-left">
                            <form method="GET" action="">
                                <input type="text" name="q" id="s" value="{{ request()->input('q') }}"
                        ...
                        <div id="action-wp" class="fl-right">
                            ...
                            @auth
                                <ul id="login-info" class="fl-left">
                                    <li>
                                        <p id="test"
                                            style="padding:27px 0px 27px 8px; color:white; position: relative; right: 30px;">
                                            {{ Auth::user()->name }}
                                        </p>
                                        <ul class="sub-menu">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('guest.viewOrder') }}">Đơn mua</a>
                                            </li>
                            ...
                            @else
                                <div id="login" class="fl-left">
                                    <p style="padding:27px 0px 27px 8px; color:white; position: relative; right: 30px;">
                            ...
                            <div id="cart-wp" class="fl-right">
                                <div id="btn-cart">
                                    <a href="{{ route('cart.show') }}" style="color: white"><i
                                            ...
                                            @foreach (Cart::content() as $row)
                                                <li class="clearfix">
                                                    ...
                                                    <div class="info fl-right">
                                                        ...
                                                        <p class="qty">Số lượng: <span>{{ $row->qty }}</span>
                                                        </p>
                                                    </div>
                                                </li>
                                            @endforeach
                                    ...
                                    <ul class="list-item">
                                        <li class="clearfix">
                                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                                <img src="{{ url('images/img-pro-13.png') }}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                        ...
                                        <li class="clearfix">
                                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                                <img src="{{ url('images/img-pro-11.png') }}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                                <a href="?page=detail_product" title="" class="product-name">Iphone
                                                    X Plus</a>
                                                <div class="price">
                                        ...
                                        <li class="clearfix">
                                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                                <img src="{{ url('images/img-pro-05.png') }}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                                <a href="?page=detail_product" title="" class="product-name">Iphone
                                                    X Plus</a>
                                        ...
                                        <li class="clearfix">
                                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                                <img src="{{ url('images/img-pro-23.png') }}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                                <a href="?page=detail_product" title="" class="product-name">Iphone
                                                    X Plus</a>
                                        ...
                                        <li class="clearfix">
                                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                                <img src="{{ url('images/img-pro-18.png') }}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                                <a href="?page=detail_product" title="" class="product-name">Iphone
                                                    X Plus</a>
                                        ...
                                        <li class="clearfix">
                                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                                <img src="{{ url('images/img-pro-15.png') }}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                                <a href="?page=detail_product" title="" class="product-name">Iphone
                                                    X Plus</a>
                ...
                <div id="foot-body">
                    <div class="wp-inner clearfix">
                        <div class="block" id="info-company">
                            ...
                            <div id="payment">
                                <div class="thumb">
                                    <img src="{{ url('images/img-foot.png') }}" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div id="btn-top"><img src="{{ url('images/icon-to-top.png') }}" alt="" /></div>
            <div id="fb-root"></div>
        </div>
    </div>
    <script>
